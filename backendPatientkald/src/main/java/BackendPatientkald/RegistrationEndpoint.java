 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "BackendPatientkald", ownerName = "BackendPatientkald", packagePath = ""))
public class RegistrationEndpoint {
     ...
     *
     * @param regString The Google Cloud Messaging registration Id to add
     */
