 ...
 */
@Api(name = "messaging", version = "v1", namespace = @ApiNamespace(ownerDomain = "BackendPatientkald", ownerName = "BackendPatientkald", packagePath = ""))
public class MessagingEndpoint {
    ...
    public static void sendMessageToOne(@Named("message") String message, @Named("regId") String regId) throws IOException {
        if (message == null || message.trim().length() == 0) {
            log.warning("Not sending message because it is empty");
            return;
        }
